...
if __name__ == '__main__':
    ...
    rna_h5_files = [os.path.join(data_path, 'exprs_10xPBMC_rna.h5')] 
    rna_label_files = [os.path.join(data_path, 'cellType_10xPBMC_rna.csv')] # csv file
    atac_h5_files = [os.path.join(data_path, 'exprs_10xPBMC_atac.h5')]
    atac_label_files = []
